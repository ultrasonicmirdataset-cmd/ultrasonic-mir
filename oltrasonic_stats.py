...
def analyze_ultrasonic(
    ...
    playing_strong_db: float = -15.0,  # "בוודאות מנגן" בתחום השמיע
) -> dict:
    """
    ניתוח אולטרא-סוני לקובץ אחד.
    """
    ...
    # ----- Frequency distribution (counts over track, רק בפריימים מנוגנים) ----- #
    ...
    # ----- Max frequency per frame (10 dB מעל רעש גלובלי) ----- #
...
def process_input(
    ...
    """
    אם input_path קובץ -> מנתח קובץ אחד.
    אם input_path תיקייה -> מנתח את כל קבצי האודיו בתוכה.
    """
    ...
    try:
        ...
        print("   כנראה שהקובץ פתוח ב-Excel או נעול ע\"י OneDrive – סגור אותו ותריץ שוב אם צריך.")
...
if __name__ == "__main__":
    # הנתיבים שביקשת:
    input_path = r"C:\Users\izhak\OneDrive\Desktop\4"
    output_dir = r"C:\Users\izhak\OneDrive\Desktop\4_results"
