...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Target sample rate. Supported presets: 16000, 44100, 48000, 96000.",
    )
...
def main() -> None:
    ...
    # The selected sample rate controls the Nyquist frequency automatically.
    # Examples: 16 kHz -> 8 kHz, 44.1 kHz -> 22.05 kHz, 96 kHz -> 48 kHz.
